...
/* =========================
   Final Page: Polaroid Ending Animation
   =========================
   This section styles the ending page.
   The images appear one by one like polaroid photos.
*/
...
/* Short introduction paragraph under the title */
.final-lead {
  max-width: 850px;
...
/* Board that holds the three polaroid cards */
.polaroid-board {
  position: relative;
  min-height: 520px;
  max-width: 980px;
...
.polaroid {
  ...
  opacity: 0;
  animation: polaroidAppear 0.85s ease forwards;
}

/* Image inside each polaroid card */
.polaroid-img {
  width: 100%;
  height: 170px;
  object-fit: cover;
...
/* Clickable image source link */
.image-credit a {
  color: #475569 !important;
  text-decoration: underline !important;
}

/* First polaroid card position */
.p1 {
  left: 5%;
  top: 45px;
  ...
  tabPanel(
    ...
    fluidRow(
      ...
      column(
        ...
        div(
          class = "modern-card final-card",
          
          # Final page main title
          h2("Air Pollution Is Not Distant from Us"),
          
          # Short introduction paragraph
          p(
            class = "final-lead",
            "PM2.5 and other air pollutants are closely connected to factories, cities, transportation, and human health. Clean air should not be taken for granted."
          ),
          
          # =========================
          # Polaroid Image Board
          # =========================
          # Three image cards appear one by one using CSS animation.
          div(
            class = "polaroid-board",
            
            # -------------------------
            # Polaroid 1: Industrial emissions
            # -------------------------
            div(
              
              class = "scroll-polaroid-section",
              
              
              
              div(
                
                class = "polaroid-frame rotate-left",
            ...
            # -------------------------
            # Polaroid 2: Human exposure
            # -------------------------
            div(
              
              class = "scroll-polaroid-section reverse-section",
              
              
              
              div(
                
                class = "polaroid-frame rotate-right",
            ...
            div(
              ...
              div(
                ...
                class = "polaroid-frame rotate-left-small",
          ...
          # =========================
          div(
            class = "final-image-message",
            
            "Clean air should not be taken for granted."
          )
        )
      )
    )
